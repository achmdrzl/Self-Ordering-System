                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                @if ($orders->invoice->status == 'settlement' || $orders->invoice->status == 'Settlement')
                                                    <a href="{{ route('print.pdf', $orders->id) }}"
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <a class="btn btn-danger" data-bs-toggle="modal"
                                                            href="#exampleModal" role="button"
                                                            style="width:150px;">Pay!</a>
                                                    @endif
                                                @endif
                            ...
                            <form action="{{ route('cash.pay', $orders->id) }}" method="POST">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon2" style="font-weight: bold">No
                                        Table</span>
                                    <input type="text" class="form-control" name="noTable"
                                        value="{{ $orders->table_id }}" readonly />
                                </div>
                                <div class="input-group mb-3">
